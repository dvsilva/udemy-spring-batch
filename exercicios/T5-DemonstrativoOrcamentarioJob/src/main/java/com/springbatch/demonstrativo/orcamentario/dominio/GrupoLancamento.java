...
public class GrupoLancamento {
	...
	public String toString() {
		return "GrupoLancamento [codigoNaturezaDespesa=" + codigoNaturezaDespesa + ", descricaoNaturezaDespesa="
				+ descricaoNaturezaDespesa + ", lancamentos=" + lancamentos + ", lancamentoTmp=" + lancamentoTmp + "]";
	}
